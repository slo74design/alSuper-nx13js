...
const HomeCart = () => {
    return (
        <div className="pt-6 pl-6 pr-3 h-[calc(100vh-150px)] w-full grid place-content-between">
            <div>
                ...
                <div className="overflow-y-scroll h-96 mt-5">
            ...
            <div className="flex flex-row items-center justify-between border-t-4 border-merca-200 pt-3">
                <p className="text-sm font-medium text-rsq-100">
                    Total aproximado
                </p>
                <p className="font-semibold text-rsq-100">45,50€</p>
            </div>
        </div>
    );
};
